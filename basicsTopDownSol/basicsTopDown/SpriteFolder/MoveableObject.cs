...
{
    public class MoveableObject : SpriteObject
    {
        [Flags]
        ...
        protected double SpeedMove { get; set; }
        ...
        public MoveableObject(ContentManager pContent, SpriteBatch pSpriteBatch, Rectangle pPosition, string pSpriteName, double pGameSizeCoefficient, Rectangle pFrameSize, Map pMap) : base(pContent, pSpriteBatch, pPosition, pSpriteName, pGameSizeCoefficient)
        {
            IsMoving = false;
        ...
        #region Method to calculate Character positions (9 slices) in pixel and in coordinates
